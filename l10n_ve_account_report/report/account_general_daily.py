...
class ReportGeneralDaily(models.AbstractModel):
    _name = 'report.l10n_ve_account_report.report_generaldaily'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('l10n_ve_account_report.report_generaldaily', docargs)
